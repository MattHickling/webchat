<x-app-layout>
   ...
   <div
  class="fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 flex flex-col rounded-r-xl bg-white bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5 z-40">
